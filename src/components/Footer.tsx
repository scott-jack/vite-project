  ...
  const Footer = ({isShort}: Props) => {
    ...
    return (
        ...
        <ul className="nav col-md-4 justify-content-center list-unstyled d-flex">
          <li className="ms-3"><a className="text-body-secondary" href="https://www.linkedin.com/in/jack-w-scott/"><img className="bi" src="../linkedin.svg" alt="" width="30" height="24"></img></a></li>
          <li className="ms-3"><a className="text-body-secondary" href="https://github.com/scott-jack"><img className="bi" src="../github.svg" alt="" width="30" height="24"></img></a></li>
        </ul>
      </footer>
    );
  };
